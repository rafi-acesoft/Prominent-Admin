...
const ViewSurgeons = () => {
  ...
  const goToEditSurgeonPage = () =>
    history.push(`${adminRoot}/edit-surgeon-details`);
      ...
      <Card className="p-3 table-white-card">
        <div className="data-table">
          <div className="py-3 px-3 table-header">
            ...
            <div className="table-card-title">Surgeons</div>
          </div>
            ...
            <tbody>
              {surgeonData.map((val) => (
                <tr>
                  ...
                  <td>{val.password}</td>
                  <td>
                    <button className="btn-blank" onClick={goToEditSurgeonPage}>
                      <AiTwotoneEdit size={22} color={"#0A0758"} />
                    </button>
                  </td>
                  <td>
                    <button className="btn-blank" onClick={showDeleteModal}>
                      <AiFillDelete size={22} color={"#0A0758"} />
                    </button>
                  </td>
                  <td>
                    <ToggleButton />
